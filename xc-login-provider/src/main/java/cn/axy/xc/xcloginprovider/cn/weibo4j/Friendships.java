package cn.axy.xc.xcloginprovider.cn.weibo4j;

import cn.axy.xc.xcloginprovider.cn.weibo4j.model.*;
import cn.axy.xc.xcloginprovider.cn.weibo4j.org.json.JSONArray;
import cn.axy.xc.xcloginprovider.cn.weibo4j.org.json.JSONObject;
import cn.axy.xc.xcloginprovider.cn.weibo4j.util.ArrayUtils;
import cn.axy.xc.xcloginprovider.cn.weibo4j.util.WeiboConfig;
...
public class Friendships extends Weibo {
	...
	public UserWapper getFriendsByID(String id) throws WeiboException {
		return Useraa.constructWapperUsers(client.get(
	...
	public String[] getFriendsBilateralIds(String uid) throws WeiboException {
		return Useraa.constructIds(client.get(WeiboConfig.getValue("baseURL")
	 ...
	 * @since JDK 1.5
	 */
	public Useraa createFriendshipsById(String uid) throws WeiboException {
		return new Useraa(client.post(
	 ...
	 * @since JDK 1.5
	 */
	public Useraa createFriendshipsByName(String screen_name)
			throws WeiboException {
		return new Useraa(client.post(
				WeiboConfig.getValue("baseURL") + "friendships/create.json",
				new PostParameter[] { new PostParameter("screen_name",
	 ...
	 * @since JDK 1.5
	 */
	public Useraa createFriendships(Map<String, String> map)
			throws WeiboException {
		PostParameter[] parList = ArrayUtils.mapToArray(map);
		return new Useraa(client.post(
				WeiboConfig.getValue("baseURL") + "friendships/create.json",
	 ...
	 * @since JDK 1.5
	 */
	public Useraa destroyFriendshipsById(String uid) throws WeiboException {
		return new Useraa(client.post(
	 ...
	 * @since JDK 1.5
	 */
	public Useraa destroyFriendshipsByName(String screen_name)
			throws WeiboException {
		return new Useraa(client.post(
				WeiboConfig.getValue("baseURL") + "friendships/destroy.json",
				new PostParameter[] { new PostParameter("screen_name",
